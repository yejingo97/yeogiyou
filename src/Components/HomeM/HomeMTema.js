...
export default function HomeMTema() {
    const initTema=[
        ...
        {index:3, title:"#WINNTER 액티비티 제대로 즐겨보자", image01:'../images/mobile_images/tema_img01.jpg', name01:"스노우 스누피", intro01:"귀여운 스누피와 함께 즐기는 체험", image02:'../images/mobile_images/tema_img02.jpg', name02:"비발디파크스키장", intro02:"짜릿하고 즐거운 겨울, NO.1 스키월드!"}
    ]
  return (
